...
d.duyuru_id, d.baslik as 'duyuru_adi', d.aciklama as 'duyuru_aciklama', d.tarih as 'duyuru_tarih', kd.isim as 'duyuru_kulup_isim', kd.url as 'duyuru_kulup_url', f.tarih
FROM favoriler f 
Left join etkinlik e on e.etkinlik_id = f.etkinlik_id 
left join duyuru d on d.duyuru_id = f.duyuru_id 
...
if ($getir){
	...
	if ($row['etkinlik_id'] != null && $row['duyuru_id'] == null){
		...
		$etkinlik_array['tarih'] = $row['tarih'];
